package com.example.vafma.ui.excursions
...
import com.example.vafma.databinding.FragmentExcursionsBinding
...
class ExcursionsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceStance: Bundle?){
        ...
        excursionpage.loadUrl("https://www.lovevamarkets.org/posts")
